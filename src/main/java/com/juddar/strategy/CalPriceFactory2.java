 ...
 */
public class CalPriceFactory2 {
    private static final String CAL_PRICE_PACKAGE = "com.juddar.strategy";//这里是一个常量，表示我们扫描策略的包
    ...
    public static CalPriceFactory2 getInstance() {
        return CalPriceFactoryInstance.instance;
    }

    private static class CalPriceFactoryInstance {

        private static CalPriceFactory2 instance = new CalPriceFactory2();
    }
